...
class MunicipiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipio" do
    assert_difference('Municipio.count') do
      post municipios_url, params: { municipio: { nome: @municipio.nome, uf_id: @municipio.uf_id } }
    end
  ...
  test "should update municipio" do
    patch municipio_url(@municipio), params: { municipio: { nome: @municipio.nome, uf_id: @municipio.uf_id } }

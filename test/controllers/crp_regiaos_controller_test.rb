...
class CrpRegiaosControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create crp_regiao" do
    assert_difference('CrpRegiao.count') do
      post crp_regiaos_url, params: { crp_regiao: { uf_id: @crp_regiao.uf_id } }
    end
  ...
  test "should destroy crp_regiao" do
    ...
    assert_redirected_to crp_regiaos_url
  end
end

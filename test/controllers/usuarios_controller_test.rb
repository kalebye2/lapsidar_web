...
class UsuariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usuario" do
    assert_difference('Usuario.count') do
      post usuarios_url, params: { usuario: { pessoa_id: @usuario.pessoa_id, profissao: @usuario.profissao } }
    end
  ...
  test "should update usuario" do
    patch usuario_url(@usuario), params: { usuario: { pessoa_id: @usuario.pessoa_id, profissao: @usuario.profissao } }
